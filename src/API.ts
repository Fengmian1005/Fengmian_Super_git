...
export type CreateComSettingsInput = {
  id?: string | null,
  owner?: string | null,
  companyName?: string | null,
  numberOfWorkers?: number | null,
...
export type ModelComSettingsConditionInput = {
  companyName?: ModelStringInput | null,
  numberOfWorkers?: ModelIntInput | null,
  hoursPerDay?: ModelIntInput | null,
  workWeek?: ModelBooleanInput | null,
  and?: Array< ModelComSettingsConditionInput | null > | null,
  or?: Array< ModelComSettingsConditionInput | null > | null,
  not?: ModelComSettingsConditionInput | null,
};

export type UpdateComSettingsInput = {
  id: string,
  owner?: string | null,
  companyName?: string | null,
  numberOfWorkers?: number | null,
...
export type DeleteComSettingsInput = {
  id?: string | null,
};
...
export type ModelComSettingsFilterInput = {
  id?: ModelIDInput | null,
  owner?: ModelStringInput | null,
  companyName?: ModelStringInput | null,
  numberOfWorkers?: ModelIntInput | null,
  hoursPerDay?: ModelIntInput | null,
  workWeek?: ModelBooleanInput | null,
  and?: Array< ModelComSettingsFilterInput | null > | null,
  or?: Array< ModelComSettingsFilterInput | null > | null,
  not?: ModelComSettingsFilterInput | null,
};
...
export type CreateComSettingsMutationVariables = {
  input: CreateComSettingsInput,
  condition?: ModelComSettingsConditionInput | null,
};

export type CreateComSettingsMutation = {
  createComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
    companyName: string | null,
    numberOfWorkers: number | null,
...
export type UpdateComSettingsMutationVariables = {
  input: UpdateComSettingsInput,
  condition?: ModelComSettingsConditionInput | null,
};

export type UpdateComSettingsMutation = {
  updateComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
...
export type DeleteComSettingsMutationVariables = {
  input: DeleteComSettingsInput,
  condition?: ModelComSettingsConditionInput | null,
};

export type DeleteComSettingsMutation = {
  deleteComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
...
export type GetComSettingsQueryVariables = {
  id: string,
};

export type GetComSettingsQuery = {
  getComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
...
export type ListComSettingssQueryVariables = {
  filter?: ModelComSettingsFilterInput | null,
  limit?: number | null,
  nextToken?: string | null,
};

export type ListComSettingssQuery = {
  listComSettingss:  {
    __typename: "ModelComSettingsConnection",
    items:  Array< {
      __typename: "ComSettings",
      id: string,
      owner: string | null,
...
export type OnCreateComSettingsSubscriptionVariables = {
  owner: string,
};

export type OnCreateComSettingsSubscription = {
  onCreateComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
...
export type OnUpdateComSettingsSubscriptionVariables = {
  owner: string,
};

export type OnUpdateComSettingsSubscription = {
  onUpdateComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
...
export type OnDeleteComSettingsSubscriptionVariables = {
  owner: string,
};

export type OnDeleteComSettingsSubscription = {
  onDeleteComSettings:  {
    __typename: "ComSettings",
    id: string,
    owner: string | null,
