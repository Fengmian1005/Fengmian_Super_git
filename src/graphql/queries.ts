...
`;
export const getComSettings = /* GraphQL */ `
  query GetComSettings($id: ID!) {
    getComSettings(id: $id) {
      id
      owner
      companyName
      numberOfWorkers
...
`;
export const listComSettingss = /* GraphQL */ `
  query ListComSettingss(
    $filter: ModelComSettingsFilterInput
    $limit: Int
    $nextToken: String
  ) {
    listComSettingss(filter: $filter, limit: $limit, nextToken: $nextToken) {
      items {
        id
        owner
        companyName
