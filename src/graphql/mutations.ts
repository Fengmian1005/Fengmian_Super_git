...
`;
export const createComSettings = /* GraphQL */ `
  mutation CreateComSettings(
    $input: CreateComSettingsInput!
    $condition: ModelComSettingsConditionInput
  ) {
    createComSettings(input: $input, condition: $condition) {
      id
      owner
      companyName
      numberOfWorkers
...
`;
export const updateComSettings = /* GraphQL */ `
  mutation UpdateComSettings(
    $input: UpdateComSettingsInput!
    $condition: ModelComSettingsConditionInput
  ) {
    updateComSettings(input: $input, condition: $condition) {
      id
      owner
      companyName
      numberOfWorkers
...
`;
export const deleteComSettings = /* GraphQL */ `
  mutation DeleteComSettings(
    $input: DeleteComSettingsInput!
    $condition: ModelComSettingsConditionInput
  ) {
    deleteComSettings(input: $input, condition: $condition) {
      id
      owner
      companyName
      numberOfWorkers
