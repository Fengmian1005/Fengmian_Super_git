...
`;
export const onCreateComSettings = /* GraphQL */ `
  subscription OnCreateComSettings($owner: String!) {
    onCreateComSettings(owner: $owner) {
      id
      owner
      companyName
      numberOfWorkers
...
`;
export const onUpdateComSettings = /* GraphQL */ `
  subscription OnUpdateComSettings($owner: String!) {
    onUpdateComSettings(owner: $owner) {
      id
      owner
      companyName
      numberOfWorkers
...
`;
export const onDeleteComSettings = /* GraphQL */ `
  subscription OnDeleteComSettings($owner: String!) {
    onDeleteComSettings(owner: $owner) {
      id
      owner
      companyName
      numberOfWorkers
